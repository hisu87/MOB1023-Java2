...
public class JFrEmployee extends javax.swing.JFrame {
    ...
    private void btn_saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_saveActionPerformed
        ...
        if (dao.save(ee) > 0) {
            lbl_message.setText("Lưu dữ liệu thành công");
            lbl_message.setForeground(Color.GREEN);
            
        } else {
            lbl_message.setText("Lưu dữ liệu thất bại");
    ...
    private void table_NhanVienMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_table_NhanVienMouseClicked
        // TODO add your handling code here:
        int pos = table_NhanVien.getSelectedRow();
    ...
    private void btn_findActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_findActionPerformed
        ...
        if(dao.find(strID) != null){
            lbl_message.setText("Tìm thấy nhân viên");
            lbl_message.setForeground(Color.GREEN);
            setModel(dao.find(strID));
