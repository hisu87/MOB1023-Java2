...
public class EmployeeDAO implements InterfaceEmployee{
    ...
    public List<Employee> openFile() {
        ...
        ls.add(new Employee("E02", "Hieu", 20, "hisu88@outlook.com", 1000000));
        ls.add(new Employee("E03", "Hieu", 20, "hisu89@outlook.com", 1000000));
        ls.add(new Employee("E04", "Hieu", 20, "hisu90@outlook.com", 1000000));
        ls.add(new Employee("E05", "Hieu", 20, "hisu91@outlook.com", 1000000));
        return ls;
    }
