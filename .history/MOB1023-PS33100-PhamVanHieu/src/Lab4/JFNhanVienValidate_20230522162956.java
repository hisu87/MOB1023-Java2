...
public class JFNhanVienValidate extends javax.swing.JFrame {
    ...
    public boolean validateForm(){
        ...
        Validator.isEmpty(txt_date, sb, "Ngày sinh không được để trống");
        Validator.isEmpty(txt_salary, sb, "Lương không được để trống");
        if(sb.length()>0)Ơ{
    ...
    private void btn_checkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_checkActionPerformed
        ...
        if(!validateForm()){
            JOptionPane.showMessageDialog(this, "Validate thành công");
        }
