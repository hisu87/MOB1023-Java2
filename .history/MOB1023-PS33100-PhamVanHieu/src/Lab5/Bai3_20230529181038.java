...
public class Bai3 extends javax.swing.JFrame {
    ...
    private void fillToTable(){
        ...
        tbl.model.setRowCount(0);
        for(staff hs : list){
            Object[] row = new Object[]{hs.getHoTen(), hs.getLuong()};
            tbl.model.addRow(row);
        }
    }
    private void initTable(){
        String [] columns = new String []{"Họ Và Tên", "Lương"};
        tbl.model.setColumnIdentifiers(columns);
        table_staff.setModel(tbl.model);
    }
    /**
